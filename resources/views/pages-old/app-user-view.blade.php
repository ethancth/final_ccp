        ...
        <div class="card-body">
          ...
          <div class="row">
            <div class="col-2 users-view-image">
              <img src="{{ asset('images/portrait/small/avatar-s-11.jpg') }}" class="w-100 rounded mb-2"
                alt="avatar">
            ...
            <div class="col-12">
              <a href="{{ route('users.edit', Auth::id()) }}" class="btn btn-primary mr-1"><i class="feather icon-edit-1"></i> Edit</a>
