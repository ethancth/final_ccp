...
<div class="modal fade" id="ServerFirewallForms" tabindex="-1" aria-labelledby="ServerFirewallForms" aria-hidden="true">
    <div class="modal-dialog modal-dialog-centered modal-lg">
        <div class="modal-content">
            ...
            <div class="modal-body pb-5 px-sm-4 mx-50">
                ...
                <form id="addNewAnyForm" class="needs-validation row gy-1 gx-2 " action="{{route("project.new.sg.store")}}" method="POST" accept-charset="UTF-8">
