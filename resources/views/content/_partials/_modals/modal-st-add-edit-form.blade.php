<div class="modal modal-slide-in fade" id="modalsslideinform">
    <div class="modal-dialog sidebar-sm">
        <div class="add-new-record modal-content pt-0" id="modal_st_form" name="modalstform">
            ...
            <div class="modal-body flex-grow-1">
                <form class="needs-validation" novalidate id="stform" name="stform" action="{{route("management.st.store")}}" method="POST" accept-charset="UTF-8">
                    ...
                    <div class="mb-1">
                        ...
                        <input
                            ...
                            class="form-control"
                            placeholder="Short sentence about system type.."
                            minlength="5"
                            required
                        />
                        <div class="valid-feedback">Looks good!</div>
