          ...
          <div class="row">
            <div class="col-xl-3 col-sm-6 col-12 mb-2 mb-xl-0">
              <div class="d-flex flex-row">
                ...
                <div class="my-auto">
                  <h4 class="fw-bolder mb-0">96</h4>
                  <p class="card-text font-small-3 mb-0">Server</p>
                </div>
              </div>
            </div>
            <div class="col-xl-3 col-sm-6 col-12 mb-2 mb-xl-0">
              <div class="d-flex flex-row">
                ...
                <div class="my-auto">
                  <h4 class="fw-bolder mb-0">250</h4>
                  <p class="card-text font-small-3 mb-0">vCPU</p>
                </div>
              </div>
            </div>
            <div class="col-xl-3 col-sm-6 col-12 mb-2 mb-sm-0">
              <div class="d-flex flex-row">
                ...
                <div class="my-auto">
                  <h4 class="fw-bolder mb-0">1.423 TB</h4>
                  <p class="card-text font-small-3 mb-0">vMemory</p>
                </div>
              </div>
            </div>
            <div class="col-xl-3 col-sm-6 col-12">
              <div class="d-flex flex-row">
                ...
                <div class="my-auto">
                  <h4 class="fw-bolder mb-0">40 TB</h4>
    ...
    <div class="col-lg-4 col-md-6 col-12">
      <div class="card">
        <div class="card-header d-flex justify-content-between align-items-center">
          <h4 class="card-title">Server Power Status</h4>
        ...
        <div class="card-body p-0">
          ...
          <div class="row border-top text-center mx-0">
            <div class="col-6 border-end py-1">
              ...
              <h3 class="fw-bolder mb-0">80</h3>
            </div>
            <div class="col-6 py-1">
              <p class="card-text text-muted mb-0">Off</p>
              <h3 class="fw-bolder mb-0">21</h3>
            </div>
          </div>
        </div>
      </div>
